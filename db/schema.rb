...
ActiveRecord::Schema.define(version: 20170517114515) do
  ...
  create_table "ratio_of_varieties", force: :cascade do |t|
    t.string   "ratio"
    t.integer  "grape_sort_id"
    t.integer  "wine_sort_id"
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
  end

  add_index "ratio_of_varieties", ["grape_sort_id"], name: "index_ratio_of_varieties_on_grape_sort_id", using: :btree
  add_index "ratio_of_varieties", ["wine_sort_id"], name: "index_ratio_of_varieties_on_wine_sort_id", using: :btree
  ...
  add_foreign_key "ratio_of_varieties", "grape_sorts"
  add_foreign_key "ratio_of_varieties", "wine_sorts"
