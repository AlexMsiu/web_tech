...
class GrapeSortsControllerTest < ActionController::TestCase
  ...
  test "should create grape_sort" do
    assert_difference('GrapeSort.count') do
      post :create, grape_sort: { date_of_collection: @grape_sort.date_of_collection, name: @grape_sort.name, place: @grape_sort.place }
    end
  ...
  test "should update grape_sort" do
    patch :update, id: @grape_sort, grape_sort: { date_of_collection: @grape_sort.date_of_collection, name: @grape_sort.name, place: @grape_sort.place }
    assert_redirected_to grape_sort_path(assigns(:grape_sort))
  end
