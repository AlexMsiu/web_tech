...
class WineSortsControllerTest < ActionController::TestCase
  ...
  test "should create wine_sort" do
    assert_difference('WineSort.count') do
      post :create, wine_sort: { name: @wine_sort.name, time_in_the_barrel: @wine_sort.time_in_the_barrel, time_in_the_bottel: @wine_sort.time_in_the_bottel, wine: @wine_sort.wine }
    end
  ...
  test "should update wine_sort" do
    patch :update, id: @wine_sort, wine_sort: { name: @wine_sort.name, time_in_the_barrel: @wine_sort.time_in_the_barrel, time_in_the_bottel: @wine_sort.time_in_the_bottel, wine: @wine_sort.wine }
    assert_redirected_to wine_sort_path(assigns(:wine_sort))
  end
